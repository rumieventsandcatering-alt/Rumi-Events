  ...
  return (
    ...
    <html lang="en" className="scroll-smooth">
      ...
      >
        ...
        <a
          href="https://wa.me/919539241400"
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:bg-[#128C7E] hover:scale-110 transition-all duration-300 flex items-center justify-center animate-bounce-slow"
